...
TB TB static constexpr uint32_t    multiDrawIndirect = CAT ((GPU_) (n) (_MULTI_DRAW_INDERECT)); NL \
...
TB TB static constexpr uint32_t    depthBounds = CAT ((GPU_) (n) (DEPTH_BOUNDS)); NL \
...
TB TB static constexpr uint32_t    textureCompressionETC2 = CAT ((GPU_) (n) (_TEXTURE_COMPRESSION_ETC2)); NL \
...
TB TB static constexpr uint32_t    shaderStorageImageExtendedFormats = CAT ((GPU_) (n) (_SAHDER_STORAGE_IMAGE_EXTENDED_FORMATS)); NL \
...
TB TB static constexpr uint32_t    sparseResidency2Samples = CAT ((GPU_) (n) (_SPARSE_RESIDENCY_2_SAMPLES)); NL \
TB TB static constexpr uint32_t    sparseResidency4Samples = CAT ((GPU_) (n) (_SPARSE_RESIDENCY_4_SAMPLES)); NL \
TB TB static constexpr uint32_t    sparseResidency8Samples = CAT ((GPU_) (n) (_SPARSE_RESIDENCY_8_SAMPLES)); NL \
TB TB static constexpr uint32_t    sparseResidency16Samples = CAT ((GPU_) (n) (_SPARSE_RESIDENCY_16_SAMPLES)); NL \
