...
struct gpu <n> NL \
{ NL \
TB static constexpr uint32_t max_image_dimension_1D =  CAT ((GPU_) (n) (_MAX_IMAGE_DIMENSION_1D)); NL \
TB static constexpr uint32_t              maxImageDimension2D = CAT ((GPU_) (n) (_MAX_IMAGE_DIMENSION_1D)); NL \
TB static constexpr uint32_t              maxImageDimension3D = CAT ((GPU_) (n) (_MAX_IMAGE_DIMENSION_1D));  NL \
TB static constexpr uint32_t              maxImageDimensionCube = CAT ((GPU_) (n) (_MAX_IMAGE_DIMENSION_CUBE));  NL \
TB static constexpr uint32_t              maxImageArrayLayers = CAT ((GPU_) (n) (_MAX_IMAGE_ARRAY_LAYERS));  NL \
TB static constexpr uint32_t              maxTexelBufferElements = CAT ((GPU_) (n) (_MAX_TEXEL_BUFFER_ELEMENTS));  NL \
TB static constexpr uint32_t              maxUniformBufferRange = CAT ((GPU_) (n) (_MAX_UNIFORM_BUFFER_RANGE));  NL \
TB static constexpr uint32_t              maxStorageBufferRange = CAT ((GPU_) (n) (_MAX_STORAGE_BUFFER_RANGE));  NL \
...
TB static constexpr uint32_t              maxPerStageDescriptorUniformBuffers = CAT ((GPU_) (n) (_MAX_PER_STAGE_DESCRIPTOR_UNIFORM_BUFFERS));  NL \
TB static constexpr uint32_t              maxPerStageDescriptorStorageBuffers = CAT ((GPU_) (n) (_MAX_PER_STAGE_DESCRIPTOR_STORAGE_BUFFERS));  NL \
TB static constexpr uint32_t              maxPerStageDescriptorSampledImages = CAT ((GPU_) (n) (_MAX_PER_STAGE_DESCRIPTOR_SAMPLED_IMAGES));  NL \
TB static constexpr uint32_t              maxPerStageDescriptorStorageImages = CAT ((GPU_) (n) (_MAX_PER_STAGE_DESCRIPTOR_STORAGE_IMAGES));  NL \
TB static constexpr uint32_t              maxPerStageDescriptorInputAttachments = CAT ((GPU_) (n) (_MAX_PER_STAGE_DESCRIPTOR_INPUT_ATTACHMENTS));  NL \
...
TB static constexpr uint32_t              maxDescriptorSetStorageImages = CAT ((GPU_) (n) (_MAX_DESCRIPTOR_SET_STORAGE_IMAGES));  NL \
TB static constexpr uint32_t              maxDescriptorSetInputAttachments = CAT ((GPU_) (n) (_MAX_DESCRIPTOR_SET_INPUT_ATTACHMENTS));  NL \
TB static constexpr uint32_t              maxVertexInputAttributes = CAT ((GPU_) (n) (_MAX_VERTEX_INPUT_ATTRIBUTES));  NL \
TB static constexpr uint32_t              maxVertexInputBindings = CAT ((GPU_) (n) (_MAX_VERTEX_INPUT_BINDINGS));  NL \
TB static constexpr uint32_t              maxVertexInputAttributeOffset = CAT ((GPU_) (n) (_MAX_VERTEX_INPUT_ATTRIBUTE_OFFSET));  NL \
TB static constexpr uint32_t              maxVertexInputBindingStride = CAT ((GPU_) (n) (_MAX_VERTEX_INPUT_BINDING_STRIDE));  NL \
TB static constexpr uint32_t              maxVertexOutputComponents = CAT ((GPU_) (n) (_MAX_VERTEX_OUTPUT_COMPONENTS));  NL \
TB static constexpr uint32_t              maxTessellationGenerationLevel = CAT ((GPU_) (n) (_MAX_TESSELLATION_GENERATION_LEVEL));  NL \
TB static constexpr uint32_t              maxTessellationPatchSize = CAT ((GPU_) (n) (_MAX_TESSELLATION_PATCH_SIZE));  NL \
TB static constexpr uint32_t              maxTessellationControlPerVertexInputComponents = CAT ((GPU_) (n) (_MAX_TESSELLATION_CONTROL_PER_VERTEX_INPUT_COMPONENTS));  NL \
...
TB static constexpr uint32_t              maxGeometryOutputVertices = CAT ((GPU_) (n) (_MAX_GEOMETRY_OUTPUT_VERTICES));  NL \
TB static constexpr uint32_t              maxGeometryTotalOutputComponents = CAT ((GPU_) (n) (_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS));  NL \
TB static constexpr uint32_t              maxFragmentInputComponents = CAT ((GPU_) (n) (_MAX_FRAGMENT_INPUT_COMPONENTS));  NL \
TB static constexpr uint32_t              maxFragmentOutputAttachments = CAT ((GPU_) (n) (_MAX_FRAGMENT_OUTPUT_ATTACHMENTS));  NL \
TB static constexpr uint32_t              maxFragmentDualSrcAttachments = CAT ((GPU_) (n) (_MAX_FRAGMENT_DUAL_SRC_ATTACHMENTS));  NL \
TB static constexpr uint32_t              maxFragmentCombinedOutputResources = CAT ((GPU_) (n) (_MAX_FRAGMENT_COMBINED_OUTPUT_RESOURCES));  NL \
TB static constexpr uint32_t              maxComputeSharedMemorySize = CAT ((GPU_) (n) (_MAX_COMPUTE_SHARED_MEMORY_SIZE));  NL \
TB static constexpr uint32_t              maxComputeWorkGroupCount[3] = {CAT ((GPU_) (n) (_MAX_COMPUTE_WORK_GROUP_COUNT_0)), CAT ((GPU_) (n) (_MAX_COMPUTE_WORK_GROUP_COUNT_1)), CAT ((GPU_) (n) (_MAX_COMPUTE_WORK_GROUP_COUNT_2))};  NL \
TB static constexpr uint32_t              maxComputeWorkGroupInvocations = CAT ((GPU_) (n) (_MAX_COMPUTE_WORK_GROUP_INVOCATIONS));  NL \
TB static constexpr uint32_t              maxComputeWorkGroupSize[3] = {CAT ((GPU_) (n) (_MAX_COMPUTE_WORK_GROUP_SIZE_0)), CAT ((GPU_) (n) (_MAX_COMPUTE_WORK_GROUP_SIZE_1)), CAT ((GPU_) (n) (_MAX_COMPUTE_WORK_GROUP_SIZE_2))};  NL \
TB static constexpr uint32_t              subPixelPrecisionBits = CAT ((GPU_) (n) (_SUB_PIXEL_PRECISION_BITS));  NL \
TB static constexpr uint32_t              subTexelPrecisionBits = CAT ((GPU_) (n) (_SUB_TEXEL_PRECISION_BITS));  NL \
TB static constexpr uint32_t              mipmapPrecisionBits = CAT ((GPU_) (n) (_MIPMAP_PRECISION_BITS));  NL \
TB static constexpr uint32_t              maxDrawIndexedIndexValue = CAT ((GPU_) (n) (_MAX_DRAW_INDEXED_INDEX_VALUE));  NL \
TB static constexpr uint32_t              maxDrawIndirectCount = CAT ((GPU_) (n) (_MAX_DRAW_INDIRECT_COUNT));  NL \
TB static constexpr float                 maxSamplerLodBias = CAT ((GPU_) (n) (_MAX_SAMPLER_LOD_BIAS));  NL \
TB static constexpr float                 maxSamplerAnisotropy = CAT ((GPU_) (n) (_MAX_SAMPLER_ANISOTROPY));  NL \
TB static constexpr uint32_t              maxViewports = CAT ((GPU_) (n) (_MAX_VIEWPORTS));  NL \
TB static constexpr uint32_t              maxViewportDimensions[2] = {CAT ((GPU_) (n) (_MAX_VIEWPORT_DIMENSIONS_0)), CAT ((GPU_) (n) (_MAX_VIEWPORT_DIMENSIONS_1))};  NL \
TB static constexpr uint32_t              viewportBoundsRange[2] = {CAT ((GPU_) (n) (_VIEWPORT_BOUNDS_RANGE_0)), CAT ((GPU_) (n) (_VIEWPORT_BOUNDS_RANGE_1))};  NL \
TB static constexpr uint32_t              viewportSubPixelBits = CAT ((GPU_) (n) (_VIEWPORT_SUB_PIXEL_BITS));  NL \
TB static constexpr size_t                minMemoryMapAlignment = CAT ((GPU_) (n) (_MIN_MEMORY_MAP_ALIGNMENT));  NL \
TB static constexpr uint64_t          minTexelBufferOffsetAlignment = CAT ((GPU_) (n) (_MIN_TEXEL_BUFFER_OFFSET_ALIGNMENT));  NL \
TB static constexpr uint64_t          minUniformBufferOffsetAlignment = CAT ((GPU_) (n) (_MIN_UNIFORM_BUFFER_OFFSET_ALIGNMENT));  NL \
TB static constexpr uint64_t          minStorageBufferOffsetAlignment = CAT ((GPU_) (n) (_MIN_STORAGE_BUFFER_OFFSET_ALIGNMENT));  NL \
TB static constexpr int32_t               minTexelOffset = CAT ((GPU_) (n) (_MIN_TEXEL_OFFSET));  NL \
TB static constexpr uint32_t              maxTexelOffset = CAT ((GPU_) (n) (_MAX_TEXEL_OFFSET));  NL \
TB static constexpr int32_t               minTexelGatherOffset = CAT ((GPU_) (n) (_MIN_TEXEL_GATHER_OFFSET));  NL \
TB static constexpr uint32_t              maxTexelGatherOffset = CAT ((GPU_) (n) (_MAX_TEXEL_GATHER_OFFSET));  NL \
TB static constexpr float                 minInterpolationOffset = CAT ((GPU_) (n) (_MIN_INTERPOLATION_OFFSET));  NL \
TB static constexpr float                 maxInterpolationOffset = CAT ((GPU_) (n) (_MAX_INTERPOLATION_OFFSET));  NL \
TB static constexpr uint32_t              subPixelInterpolationOffsetBits = CAT ((GPU_) (n) (_SUB_PIXEL_INTERPOLATION_OFFSET_BITS));  NL \
TB static constexpr uint32_t              maxFramebufferWidth = CAT ((GPU_) (n) (_MAX_FRAMEBUFFER_WIDTH));  NL \
TB static constexpr uint32_t              maxFramebufferHeight = CAT ((GPU_) (n) (_MAX_FRAMEBUFFER_HEIGHT));  NL \
...
TB static constexpr uint32_t    sampledImageIntegerSampleCounts = CAT ((GPU_) (n) (_SAMPLED_IMAGE_INTEGER_SAMPLE_COUNTS));  NL \
TB static constexpr uint32_t    sampledImageDepthSampleCounts = CAT ((GPU_) (n) (_SAMPLED_IMAGE_DEPTH_SAMPLE_COUNTS));  NL \
TB static constexpr uint32_t    sampledImageStencilSampleCounts = CAT ((GPU_) (n) (_SAMPLED_IMAGE_STENCIL_SAMPLE_COUNTS));  NL \
TB static constexpr uint32_t    storageImageSampleCounts = CAT ((GPU_) (n) (_STORAGE_IMAGE_SAMPLE_COUNTS));  NL \
TB static constexpr uint32_t              maxSampleMaskWords = CAT ((GPU_) (n) (_MAX_SAMPLE_MASK_WORDS));  NL \
TB static constexpr uint32_t              timestampComputeAndGraphics = CAT ((GPU_) (n) (_TIMESTAMP_COMPUTE_AND_GRAPHICS));  NL \
TB static constexpr float                 timestampPeriod = CAT ((GPU_) (n) (_TIMESTAMP_PERIOD));  NL \
TB static constexpr uint32_t              maxClipDistances = CAT ((GPU_) (n) (_MAX_CLIP_DISTANCES));  NL \
TB static constexpr uint32_t              maxCullDistances = CAT ((GPU_) (n) (_MAX_CULL_DISTANCES));  NL \
TB static constexpr uint32_t              maxCombinedClipAndCullDistances = CAT ((GPU_) (n) (_MAX_COMBINED_CLIP_AND_CULL_DISTANCES));  NL \
TB static constexpr uint32_t              discreteQueuePriorities = CAT ((GPU_) (n) (_DISCRETE_QUEUE_PRIORITIES));  NL \
TB static constexpr uint32_t              pointSizeRange[2] = {CAT ((GPU_) (n) (_POINT_SIZE_RANGE_0)), CAT ((GPU_) (n) (_POINT_SIZE_RANGE_1))};  NL \
TB static constexpr uint32_t              lineWidthRange[2] = {CAT ((GPU_) (n) (_LINE_WIDTH_RANGE_0)), CAT ((GPU_) (n) (_LINE_WIDTH_RANGE_1))};  NL \
